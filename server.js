...
// TEMP: BACKFILL OLD BRANCH SALES INTO INVOICES
//app.post("/backfill-invoices", verifyToken, adminOnly, async (req, res) => {
//    const client = await pool.connect();
...
//                AND ii.product_id = bs.product_id
//                AND ii.qty = bs.qty
//                AND ii.line_total = bs.price
//            )
...
//            const invoiceNo = "OLD-INV-" + sale.branch_sale_id;

//            const invoiceResult = await client.query(`
//                INSERT INTO invoices 
//                (invoice_no, customer_id, branch_id, user_id, payment_method, total, date)
...
//            const unitPrice = Number(sale.price || 0) / Number(sale.qty || 1);
...
//
//        res.json({
//            message: "Old sales converted to invoices",
